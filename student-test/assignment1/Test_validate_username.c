...
void test_validate_my_username()
{
	...
	char* conf_user = malloc_username_from_conf_file();
	TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_user, conf_user, "Username in conf/username.txt does not match my_username() return value!"); 
	free(conf_user);
}
